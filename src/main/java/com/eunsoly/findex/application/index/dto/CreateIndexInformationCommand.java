...
public record CreateIndexInformationCommand(
    ...
    public static CreateIndexInformationCommand of(
            String indexClassification,
            String indexName,
            Integer employedItemsCount,
            LocalDate basePointInTime,
            Float baseIndex,
            Boolean favorite) {
        return new CreateIndexInformationCommand(
                indexClassification, indexName,
                employedItemsCount, basePointInTime,
                baseIndex, favorite);
    }
    ...
    public IndexInformation toEntity(String type) {
        ...
        if (sourceType == SourceType.USER) {
            return IndexInformation.createByUser(
        ...
        return IndexInformation.createByIntegration(
                this.indexClassification,
                this.indexName,
                this.employedItemsCount,
                this.basePointInTime,
