...
public record UpsertIndexDataRequest(Long indexInfoId, LocalDate baseDate, BigDecimal marketPrice, BigDecimal closingPrice, BigDecimal highPrice,
    ...
    public UpdateIndexDataCommand toUpdatedCommand(Long id) {
        return UpdateIndexDataCommand.of(id, this.baseDate, this.marketPrice, this.closingPrice, this.highPrice, this.lowPrice, this.versus,
                this.fluctuationRate, this.tradingQuantity, this.tradingPrice, this.marketTotalAmount);
