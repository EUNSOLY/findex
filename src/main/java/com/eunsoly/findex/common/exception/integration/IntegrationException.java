package com.eunsoly.findex.common.exception.integration;
...
public class IntegrationException extends ApplicationException {
     ...
     */
    protected IntegrationException(ErrorCode errorCode, Throwable cause) {
     ...
     * @param cause 원인 예외
     */
    protected IntegrationException(ErrorCode errorCode, String message, Throwable cause) {
     ...
     * @param cause 원인 예외
     */
    protected IntegrationException(ErrorCode errorCode, Map<String, Object> detail, Throwable cause) {
        this(errorCode, errorCode.getDefaultMessage(), detail, cause);
    }

    /**
     * 직접 지정한 메시지와 추가 정보로 예외를 생성합니다. 다른 생성자들은 모두 이 생성자를 호출합니다.
     *
     * @param errorCode 에러 코드
     * @param message 에러 코드의 기본 메시지 대신 사용할 메시지
     ...
     * @param cause 원인 예외
     */
    protected IntegrationException(ErrorCode errorCode, String message, Map<String, Object> detail, Throwable cause) {
