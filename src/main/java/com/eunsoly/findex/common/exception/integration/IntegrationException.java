...
public class IntegrationException extends ApplicationException {
    ...
    protected IntegrationException(
            ErrorCode errorCode, Map<String, Object> detail, Throwable cause) {
     ...
     */
    protected IntegrationException(
            ErrorCode errorCode, String message, Map<String, Object> detail, Throwable cause) {
